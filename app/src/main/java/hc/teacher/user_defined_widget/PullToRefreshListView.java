package hc.teacher.user_defined_widget;
...
public class PullToRefreshListView extends ListView implements AbsListView.OnScrollListener
{
    ...
    private boolean isRefreshable;          //判断是否是可刷新状态
    private boolean loadEnable;             //开启或关闭加载更多功能
    private boolean isLoading;              //判断是否正在加载
    private boolean isLoadFull;             //判断是否已经加载全部数据
    ...
    private void init(Context context)
    {
        ...
        footerView = (RelativeLayout)inflater.inflate(R.layout.lv_footer, null);
        lvFooterTipsTv = (TextView)footerView.findViewById(R.id.lvFooterTipsTv);
        lvFooterProgressbar = (ProgressBar)footerView.findViewById(R.id.lvFooterProgressbar);
        ...
        // 设置内边距，距离顶部为一个负的整个布局的高度，正好把头部隐藏
    ...
    private void changeHeaderViewByState()
    {
        ...
        case RELEASE_TO_REFRESH:
            ...
            lvHeaderTipsTv.setText(R.string.release_to_refresh);
            break;
        case PULL_TO_REFRESH:
            ...
            if (isBack)
            {
                ...
                lvHeaderTipsTv.setText(R.string.pull_to_refresh);
            }
            else
            {
                lvHeaderTipsTv.setText(R.string.pull_to_refresh);
        ...
        case REFRESHING:
            ...
            lvHeaderTipsTv.setText(R.string.refreshing);
            lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);
            break;
        case DONE:
            headerView.setPadding(0, -1 * headerContentHeight, 0, 0);
            lvHeaderProgressBar.setVisibility(View.GONE);
            lvHeaderArrowIv.clearAnimation();
            lvHeaderArrowIv.setImageResource(R.drawable.person_image01);
            lvHeaderTipsTv.setText(R.string.pull_to_refresh);
            lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);
            break;
        }
    ...
    {
        state = DONE;
        lvHeaderLastUpdatedTv.setText(getResources().getString(R.string.last_update) + " " + new Date().toLocaleString());
        changeHeaderViewByState();
    }
