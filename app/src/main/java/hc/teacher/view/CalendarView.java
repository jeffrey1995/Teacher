...
//                            Toast.makeText(getContext(),selectedStartDate.toLocaleString(),Toast.LENGTH_SHORT).show();
//                        }
//                    };
    ...
    private class Surface {
        ...
        public int bgColor = getResources().getColor(R.color.theme_color);
